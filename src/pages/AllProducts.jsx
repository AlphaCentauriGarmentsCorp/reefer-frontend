...
// ACCESSORIES is gone with the Bags/Socks types it existed to hold — no product
// carries that audience, so the chip only ever produced an empty rack.
const AUDIENCES = [
  { label: "ALL", value: "" },
  { label: "MEN", value: "men" },
...
// Underwear, Bags and Socks removed along with the OTHER group they filled. Every one
// of them showed a "0" count and filtered to an empty rack, which reads as a broken
// filter rather than an empty category.
const TYPE_GROUPS = [
  { heading: "TOPWEAR", items: [{ key: "hoodie", label: "Hoodies" }, { key: "tee", label: "Tees" }] },
  { heading: "BOTTOMWEAR", items: [{ key: "shorts", label: "Shorts" }] },
];
      ...
      <section role="search" style={{ maxWidth: 1440, margin: "0 auto", padding: "0 32px 18px" }}>
        ...
        >
          ...
          <input
            ...
            placeholder="SEARCH THE DROP — TEES, HOODIES, SHORTS…"
