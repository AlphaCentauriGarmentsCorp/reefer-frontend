...
const VALUES = [
  ...
  { num: "02", title: "No restocks", copy: "Gone means gone. Every colorway retires the moment it sells out. No re-runs, no FOMO farming." },
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1.1fr 0.9fr", gap: 48, alignItems: "center" }}>
          <div style={{ display: "flex", flexDirection: "column", gap: 22 }}>
            ...
            <p style={{ margin: 0, fontSize: 16, lineHeight: 1.7, color: "#6B6357", fontWeight: 500 }}>
              We're a small crew out of Quezon City printing 1–2 color halftone tees in short runs. No committees deciding what's cool. No restocks to chase. When a colorway is gone, it becomes someone else's origin story — the one they tell about the drop they actually caught.
            </p>
            <p style={{ margin: 0, fontSize: 16, lineHeight: 1.7, color: "#6B6357", fontWeight: 500 }}>
