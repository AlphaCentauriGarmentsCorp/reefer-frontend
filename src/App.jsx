...
import { BrowserRouter, Routes, Route, Link, matchRoutes, useLocation, useNavigationType } from "react-router-dom";
    ...
    <div style={{ background: "#F6F1E7", color: "#101010", minHeight: "100vh", overflowX: "clip" }}>
      ...
      >
        ...
        <p style={{ margin: 0, maxWidth: 560, fontSize: 18, lineHeight: 1.6, color: "#6B6357" }}>
          This page washed out with the last drop — but the water is still moving over here.
        </p>
...
const PAGES = [
  { path: "/", element: <Home />, title: "Ride the wave", description: "Small-batch streetwear printed in Quezon City. Tees, hoodies and shorts from the current REEFER MNL drop." },
  { path: "/shop", element: <Shop />, title: "Shop by collection", description: "Every REEFER MNL collection in one place — tees, hoodies and shorts, plus new arrivals and best sellers." },
  { path: "/products", element: <AllProducts />, title: "Shop everything", description: "The full REEFER MNL catalogue. Filter by type, audience, size and tag." },
  ...
  { path: "/about", element: <About />, title: "About", description: "A small Quezon City print shop making streetwear in short runs." },
